...
<div id="main">
    ...
    <div class="row mt-5">
        <div class="row offset-2 col-6">
            ...
            <div class="col-4"><input type="text" class="form-control col-2" id="findkey" value="${param.fkey}"></div>
            <div class="col-3">
    ...
    <div class="row mt-2">
        <div class="offset-2 col-8">
            <table class="table table-striped tbborder">
                ...
                <tr>
                    <td>${bd.bno}</td>
                    <td><a href="/board/view?bno=${bd.bno}">${bd.title}</a></td><%--<a href="/board/view?bno=${bd.bno}">--%>
                    <td>${bd.userid}</td>
