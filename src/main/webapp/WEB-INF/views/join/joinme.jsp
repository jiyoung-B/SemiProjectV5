...
<%--                                data-bs-toggle="modal" data-bs-target="#zipmodal">--%>
                ...
                <div class="row col-11 offset-1 mb-3 align-items-center">
                    ...
                    <div class="col-2">
                        <select class="form-select border-danger" id="tel1">
                            <option>국번</option>
                            <option>010</option>
                            <option>011</option>
                        </select>
                    ...
                    <div class="col-2">
                        <input class="form-control border-danger" id="tel2">
                    </div>
                    <div class="col-2">
                        <input class="form-control border-danger" id="tel3">
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="sendzip"><i class="fas fa-check-square"></i>선택하고 닫기</button>
                </div>
            </div>
        </div>
    </div>
