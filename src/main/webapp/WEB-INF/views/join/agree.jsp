...
<div id="main">
    ...
    <nav class="mt-3">
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><button class="btn btn-success active">이용약관</button></li>
            <li class="breadcrumb-item"><button class="btn btn-light">실명확인</button></li>
            <li class="breadcrumb-item"><button class="btn btn-light">정보입력</button></li>
            <li class="breadcrumb-item"><button class="btn btn-light">가입완료</button></li>
        </ul>
    </nav>
    <div class="mt-5">
        <h2>사이트 약관 동의</h2>
        ...
        <div class="card card-body bg-light mt-5 mx-3 ">
            ...
            <form name="agreefrm" id="agreefrm">
                <div class="form-group mt-3">
                            <textarea class="form-control border-danger" rows="10">
카카오계정 약관
...
Copyright © Kakao Corp. All rights reserved.
                ...
                <div class="form-check d-flex justify-content-end mt-3">
                    ...
                    <label for="agree1" class="form-check-label text-primary">이용약관에 동의합니다</label>
                </div>
            </form>
        </div>
...
Copyright © Kakao Corp. All rights reserved.
                ...
                <div class="form-check d-flex justify-content-end mt-3">
                    ...
                    <label for="agree2" class="form-check-label text-primary">개인정보 수집 및 이용에 동의합니다</label>
                </div>
            </form>
        </div>
