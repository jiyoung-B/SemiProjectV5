...
<div id="main">
    ...
    <nav class="mt-3">
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><button type="button" disabled class="btn btn-success">이용약관</button></li>
            <li class="breadcrumb-item"><button type="button" disabled class="btn btn-success active">실명확인</button></li>
            ...
            <form id="checkfrm1" name="checkfrm1">
                <div class="row">
                    <div class="col-5 offset-1">
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <input type="text" id="name" name="name" class="form-control border-warning"></div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-3">
                                <select name="bmonth" id="bmonth" class="form-select col-3 border-warning">
                                    <option>월</option>
                                    <option>01</option>
                                    <option>02</option>
                                    <option>03</option>
                            ...
                            <div class="col-3">
                                <select name="bday" id="bday" class="form-select col-3 border-warning">
                                    <option>일</option>
                                    <option>01</option>
                                    <option>02</option>
                                    <option>03</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-3 mt-2">
                                <div class="form-check">
                                    <input type="radio" id="gfmale" name="gender" value="f" class="form-check-input">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <button type="button" id="check1btn" class="btn btn-primary">
                            <i class="fas fa-check"></i> 확인하기</button>
                        <button type="button" id="cancle1btn" class="btn btn-danger">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <button type="button" id="check2btn" class="btn btn-primary">
                            <i class="fas fa-check"></i> 확인하기</button>
                        <button type="button" id="cancle2btn" class="btn btn-danger">
                            <i class="fas fa-times"></i> 취소하기</button>
                    </div>
                </div>
            </form>
